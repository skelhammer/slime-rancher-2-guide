## Chapter 12: The Digsite - Weather Slime Operations
...
**If you haven't collected these slimes:** Skip this chapter and go to Chapter 13.
...
The Digsite is accessed through The Den's eastern passage. This 4-plot expansion will house your weather event slimes.
...
- ✅ Auto-Feeders installed and stocked on both corrals (if built)
- ✅ Painted Hen breeding operation in Plot 3 (if built)
- ✅ Prickle Pear garden producing in Plot 1 (if built)
- ✅ Weather event slimes fully integrated OR chapter skipped
...
- **Farming Strategy:** Use throwable items (Pink Plorts, vegetables) to hit Shadow Slimes. During Prisma Disruptions, feed Unstable food to slimes, then walk through Ancient Stabilizers to automatically convert Unstable Plorts to Prisma Plorts in your inventory.
