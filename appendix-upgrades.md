...
| Shadow Sureshot | 10,000 | 20 Sloomber Plort, 20 Twin Plort, 20 Hyper Plort, 1 Strange Diamond, 1 Shadow Sureshot Module | Doubles the amount of shadow plorts produced when hit |
...
| Disruption Detector | 500 | 10 Prisma Plorts, 5 Tin Petal, 5 Dream Bubble | Tracks the status of Prisma Disruptions in the Grey Labyrinth, showing when one is active or approaching. |
| Nullifier | 1,000 | 20 Shadow Plorts, 20 Hyper Plorts, 20 Twin Plorts, 20 Sloomber Plorts | Story Item. A device used to stabilize the Prismacore at the end of the main story. |
...
| Dream Lantern | 10,000 | 50 Honey Plorts, 50 Crystal Plorts, 10 Lava Dust, 10 Silky Sand, 1 Strange Diamond | Emits a calming light that pacifies slimes and can put them to sleep. |
...
| Quantum Drone Station | 5,000 | 100 Flutter Plorts, 15 Lava Dust, 15 Wild Honey, 3 Strange Diamonds, 1 Drone Station Module | An automated worker that can be programmed to transport items around the ranch or harvest resources in the wild. |
