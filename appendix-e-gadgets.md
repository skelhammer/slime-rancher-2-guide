...
| Radiant Projector | 500 | 10 Hunter Plorts, 10 Boom Plorts, 5 Silky Sand, 5 Lava Dust | A placeable mirror used to redirect light beams and solve puzzles in the Grey Labyrinth. Once a puzzle is solved, the projector can be picked up and reused - the puzzle remains solved. |
| Disruption Detector | 500 | 10 Prisma Plorts, 5 Tin Petal, 5 Dream Bubble | Tracks the status of Prisma Disruptions in the Grey Labyrinth. Place it to add a pin to the map showing disruption status: White icon = no disruption, Yellow icon = upcoming disruption, Red icon = disruption ongoing. Blueprint and one free Detector obtained from Gigi in Impossible Sky (grassy area). |
